...
from dd1750Creator import (contains_invalid_chars, is_valid_filename, get_items_to_print_to_1750, get_inventory, combine_same_items, format_for_1750, char_limit_items, number_of_items, fill_field, char_limit_item)
...
class Test_dd1750Creator(unittest.TestCase):
    ...
    def test_fill_field(self):
        ...
        res_dict = fill_field(1, "GPS", fillable_fields_dict)
        expected_dict['box_1'] = "GPS"
        self.assertEqual(res_dict, expected_dict)

        res_dict = fill_field(3, "Ruck", fillable_fields_dict)
        expected_dict['box_3'] = "Ruck"
        self.assertEqual(res_dict, expected_dict)
        
        res_dict = fill_field(18, "M-110 S/n 2342342", fillable_fields_dict)
        expected_dict['box_18'] = "M-110 S/n 2342342"
        self.assertEqual(res_dict, expected_dict)

        res_dict = fill_field(19, "PC s/n 234324", fillable_fields_dict)
        self.assertEqual(res_dict, expected_dict)
        print(res_dict)
